import com.khg.storm.CustomRoundRobinGrouping;
...
public class TestTopology2 {
    private static final Logger LOG = LoggerFactory.getLogger(TestTopology2.class);
    ...
    private void start() {
        ...
        builder.setBolt(BOLT1, bolt1, numBolt1 * numWorker)
                        .customGrouping(SPOUT_ID,new CustomRoundRobinGrouping());
        builder.setBolt(BOLT2, bolt2, numBolt2 * numWorker)
                .customGrouping(BOLT1, new CustomRoundRobinGrouping());
    ...
    public static void main(String[] args) {
        TestTopology2 topology = new TestTopology2();
